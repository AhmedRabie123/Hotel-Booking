...
@section('button')
    <a href="{{ route('admin_room_create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Room</a>
@endsection
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row bdb1 pt_10 mb_0">
                                                            ...
                                                            <div class="col-md-8">{!! nl2br($row->description) !!}
                                                            </div>
                                                        </div>
